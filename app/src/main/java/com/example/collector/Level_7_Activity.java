...
public class Level_7_Activity extends Activity {
    ...
    private int score;
    private final int current_level_req_score = 700;
    ...
    public void win()
    {
        final int CURRENT_LEVEL = 7;

        Intent scoreIntent_win = new Intent(Level_7_Activity.this, level_up_class.class);
        ...
        Level_7_Activity.super.onBackPressed();
    }

    public void lose()
    {
        Intent scoreIntent_lose = new Intent(Level_7_Activity.this, CurrentScore_class.class);
    ...
    public void exit()
    {
        final AlertDialog.Builder builder = new AlertDialog.Builder(Level_7_Activity.this);
        ...
        builder.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                if(levelsflag)
                {
                    Intent intent_play = new Intent(Level_7_Activity.this,Levels_class.class);
                    startActivity(intent_play);
                }
                else
                {
                    Intent menuIntent = new Intent(Level_7_Activity.this, MainActivity.class);
    ...
    protected void onResume()
    {
        ...
        if(musicCounter == 0)
        {
            ...
            } else
            {
                doBindService();
                Intent music = new Intent();
                music.setClass(Level_7_Activity.this, MusicPlayer.class);
                startService(music);
                if (mServ != null)
                {
                    mServ.resumeMusic();
    ...
    public void setting (View view)
    {
        ...
        final AlertDialog.Builder alertSetting = new AlertDialog.Builder(Level_7_Activity.this);
